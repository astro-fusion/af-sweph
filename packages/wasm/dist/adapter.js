...
class WasmAdapter {
    ...
    swe_rise_trans(tjd_ut, ipl, starname, epheflag, rsmi, geopos, atpress, attemp) {
        ...
        try {
            ...
            const ret = this.module._swe_rise_trans(tjd_ut, ipl, starnamePtr, epheflag, rsmi, geoposPtr, atpress, attemp, tretPtr, serrPtr);
            if (ret < 0) {
                return { error: this.module.UTF8ToString(serrPtr) };
            }
            return {
