...
__export(index_exports, {
  CalculationTier: () => import_sweph_core2.CalculationTier,
  EngineFeatures: () => import_sweph_core2.EngineFeatures,
  FeatureNotSupportedError: () => import_sweph_core2.FeatureNotSupportedError,
  LiteEngine: () => LiteEngine,
  createLiteSweph: () => createLiteSweph
});
module.exports = __toCommonJS(index_exports);

// src/engine.ts
var Astronomy = __toESM(require("astronomy-engine"));
var import_sweph_core = require("@af/sweph-core");
var PLANET_MAPPING = [
...
var LiteEngine = class {
  constructor() {
    this.tier = import_sweph_core.CalculationTier.FAST;
    this.name = "lite";
    this.supportedFeatures = /* @__PURE__ */ new Set([
      import_sweph_core.EngineFeatures.PLANETS,
      import_sweph_core.EngineFeatures.SUN_TIMES,
      import_sweph_core.EngineFeatures.MOON_PHASE,
      import_sweph_core.EngineFeatures.AYANAMSA
      // approximated
    ]);
  ...
  async calculateLagna(_date, _location, _options) {
    throw new import_sweph_core.FeatureNotSupportedError(import_sweph_core.EngineFeatures.LAGNA, this.tier);
  }
  /**
...
// src/index.ts
var import_sweph_core2 = require("@af/sweph-core");
